...
/* Date: 02/14/2014                                   */
/* Program: This program calculates the               */
...
int main()
{
    ...
    cout << "What was the lethal dose of soda for the mouse? (in fluid onces): " << endl;
    cin >> lethalMouse;
    ...
    lethalHuman = weightRatio * lethalMouse; // The lethal amount for a human

    sweetLethalHuman = lethalHuman * sweetPercent; // The amount of sweetener in a lethal dose

    cout << "You can consume " << lethalHuman << " ounces of soda, which contains " << sweetLethalHuman << " ounces of sweetener." << endl;
